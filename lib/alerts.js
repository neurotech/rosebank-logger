...
var _sendAlert = function (item) {
  mailgun.messages().send({
    ...
    html: '<strong>Testing HTML</strong> ' + item.name + ' has reported an error at ' + item.time + '. The error object is as follows: <br><br><pre>' + prettyjson.render(item, {noColor: true}) + '</pre>'
